...
class HKDFTest extends TestCase{
    ...
    public function testVectorV3(): void{
        ...
        $actualOutput = HKDF::createFor(3)->deriveSecrets($ikm,$salt,$info,42);

        $this->assertTrue($okm===$actualOutput);
    }
    ...
    public function testVectorLongV3(): void{
        ...
        $actualOutput = HKDF::createFor(3)->deriveSecrets($ikm,$salt,$info,82);
        $this->assertTrue($okm===$actualOutput);
    }
    ...
    public function testVectorV2(): void{
        ...
        $okm = implode([
            "\x6e", "\xc2", "\x55", "\x6d", "\x5d", "\x7b", "\x1d", "\x81",
            "\xde", "\xe4", "\x22", "\x2a", "\xd7", "\x48", "\x36", "\x95",
            "\xdd", "\xc9", "\x8f", "\x4f", "\x5f", "\xab", "\xc0", "\xe0",
            "\x20", "\x5d", "\xc2", "\xef", "\x87", "\x52", "\xd4", "\x1e",
            "\x04", "\xe2", "\xe2", "\x11", "\x01", "\xc6", "\x8f", "\xf0",
            "\x93", "\x94", "\xb8", "\xad", "\x0b", "\xdc", "\xb9", "\x60",
            "\x9c", "\xd4", "\xee", "\x82", "\xac", "\x13", "\x19", "\x9b",
            "\x4a", "\xa9", "\xfd", "\xa8", "\x99", "\xda", "\xeb", "\xec",
        ]);

        $actualOutput = HKDF::createFor(2)->deriveSecrets($ikm,$salt,$info,64);
        $this->assertTrue($okm===$actualOutput);
    }
