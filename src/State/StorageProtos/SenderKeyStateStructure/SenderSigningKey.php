...
/**
 * Generated from protobuf message <code>textsecure.SenderKeyStateStructure.SenderSigningKey</code>
 */
...
class_alias(SenderSigningKey::class, \WhisperSystems\LibSignal\State\StorageProtos\SenderKeyStateStructure_SenderSigningKey::class);
