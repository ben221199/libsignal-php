...
/**
 * Generated from protobuf message <code>textsecure.SessionStructure.PendingKeyExchange</code>
 */
...
class_alias(PendingKeyExchange::class, \WhisperSystems\LibSignal\State\StorageProtos\\SessionStructure_PendingKeyExchange::class);
